...
public static class BlueprintInit
{
    ...
    public static void Postfix(Kingmaker.Blueprints.JsonSystem.BlueprintsCache __instance)
    {
        ...
        Run(nameof(Feats.AdvancedAssassinPath),        Feats.AdvancedAssassinPath.Configure,         logger);
        Run(nameof(Feats.AdvancedBrawlerPath),         Feats.AdvancedBrawlerPath.Configure,          logger);
        Run(nameof(Feats.AdvancedDervishPath),         Feats.AdvancedDervishPath.Configure,          logger);
        Run(nameof(Feats.AdvancedFeralWarriorPath),    Feats.AdvancedFeralWarriorPath.Configure,     logger);
        Run(nameof(Feats.AdvancedMindKnightPath),      Feats.AdvancedMindKnightPath.Configure,       logger);
