...
public static class MartialPower
{
    public static void Configure()
    {
        ...
        BuildVariant("Weaponmaster",  "Weaponmaster Maneuver", "+2 dodge AC and +2 competence to attack rolls for 1 round",
                     Guids.MartialPowerWeaponmasterManeuver, Guids.WeaponmasterPath, Guids.WeaponmasterManeuverBuff, icon);
        BuildVariant("Weaponmaster",  "Burst of Speed",        "+30 ft enhancement speed and +4 competence to attack rolls for 1 round",
                     Guids.MartialPowerWeaponmasterExpanded, Guids.WeaponmasterExpandedManeuver, Guids.WeaponmasterExpandedManeuverBuff, icon);
        BuildVariant("Brawler",       "Brawler Maneuver",      "+7 competence damage on your next melee strike",
                     Guids.MartialPowerBrawlerManeuver, Guids.BrawlerPath, Guids.BrawlerManeuverBuff, icon);
        BuildVariant("Brawler",       "Steel Sinews",          "+4 dodge AC and Fast Healing 2 for 1 round",
                     Guids.MartialPowerBrawlerExpanded, Guids.BrawlerExpandedManeuver, Guids.BrawlerExpandedManeuverBuff, icon);
        BuildVariant("Archer",        "Archer Maneuver",       "+4 competence to attack rolls on your next strike",
                     Guids.MartialPowerArcherManeuver, Guids.ArcherPath, Guids.ArcherManeuverBuff, icon);
        BuildVariant("Archer",        "Twin Shot",             "Haste for 1 round (extra attack on full attacks, +1 dodge AC, +1 Reflex, +30 ft speed)",
                     Guids.MartialPowerArcherExpanded, Guids.ArcherExpandedFeature, Guids.ArcherExpandedBuff, icon);
        BuildVariant("Ascetic",       "Ascetic Maneuver",      "+4 dodge bonus to AC for 1 round",
                     Guids.MartialPowerAsceticManeuver, Guids.AsceticPath, Guids.AsceticManeuverBuff, icon);
        BuildVariant("Ascetic",       "Wholeness of Body",     "Heal yourself for HP equal to your manifester level",
                     Guids.MartialPowerAsceticExpanded, Guids.AsceticExpandedFeature, Guids.AsceticExpandedBuff, icon);
        BuildVariant("Assassin's",    "Assassin's Maneuver",   "+7 competence damage on your next strike",
                     Guids.MartialPowerAssassinsManeuver, Guids.AssassinsPath, Guids.AssassinsManeuverBuff, icon);
        BuildVariant("Assassin's",    "Mindblade Strike",      "+4 competence damage and +4 competence to all saves for 1 round",
                     Guids.MartialPowerAssassinsExpanded, Guids.AssassinsExpandedFeature, Guids.AssassinsExpandedBuff, icon);
        BuildVariant("Dervish",       "Dervish Maneuver",      "+2 competence to attack and damage rolls for 1 round",
                     Guids.MartialPowerDervishManeuver, Guids.DervishPath, Guids.DervishManeuverBuff, icon);
        BuildVariant("Dervish",       "Whirlwind Step",        "Haste for 1 round (extra attack on full attacks, +1 dodge AC, +1 Reflex, +30 ft speed)",
                     Guids.MartialPowerDervishExpanded, Guids.DervishExpandedFeature, Guids.DervishExpandedBuff, icon);
        BuildVariant("Feral Warrior", "Feral Warrior Maneuver","+7 competence damage on your next strike",
                     Guids.MartialPowerFeralWarriorManeuver, Guids.FeralWarriorPath, Guids.FeralWarriorManeuverBuff, icon);
        BuildVariant("Feral Warrior", "Feral Rend",            "Keen weapon edge (doubled critical threat range) for 1 round",
                     Guids.MartialPowerFeralWarriorExpanded, Guids.FeralWarriorExpandedFeature, Guids.FeralWarriorExpandedBuff, icon);
        BuildVariant("Gladiator",     "Gladiator Maneuver",    "+4 competence to CMB for 1 round",
                     Guids.MartialPowerGladiatorManeuver, Guids.GladiatorPath, Guids.GladiatorManeuverBuff, icon);
        BuildVariant("Gladiator",     "Gladiator's Will",      "+4 competence to all saving throws for 1 round",
                     Guids.MartialPowerGladiatorExpanded, Guids.GladiatorExpandedFeature, Guids.GladiatorExpandedBuff, icon);
        BuildVariant("Infiltrator",   "Infiltrator Maneuver",  "+4 competence to Persuasion and +2 competence damage for 1 round",
                     Guids.MartialPowerInfiltratorManeuver, Guids.InfiltratorPath, Guids.InfiltratorManeuverBuff, icon);
        BuildVariant("Infiltrator",   "Hidden Step",           "+20 ft enhancement speed and +6 competence to Stealth for 1 round",
                     Guids.MartialPowerInfiltratorExpanded, Guids.InfiltratorExpandedFeature, Guids.InfiltratorExpandedBuff, icon);
        BuildVariant("Interceptor",   "Interceptor Maneuver",  "+2 competence to attack and damage rolls for 1 round",
                     Guids.MartialPowerInterceptorManeuver, Guids.InterceptorPath, Guids.InterceptorManeuverBuff, icon);
        BuildVariant("Interceptor",   "Save Another",          "DR 5/— for 1 round",
                     Guids.MartialPowerInterceptorExpanded, Guids.InterceptorExpandedFeature, Guids.InterceptorExpandedBuff, icon);
        BuildVariant("Mind Knight",   "Mind Knight Maneuver",  "+2 competence to attack and damage rolls for 1 round",
                     Guids.MartialPowerMindKnightManeuver, Guids.MindKnightPath, Guids.MindKnightManeuverBuff, icon);
        BuildVariant("Mind Knight",   "Mental Strike",         "+4 insight Initiative and +4 dodge AC for 1 round",
                     Guids.MartialPowerMindKnightExpanded, Guids.MindKnightExpandedFeature, Guids.MindKnightExpandedBuff, icon);
        BuildVariant("Survivor",      "Survivor Maneuver",     "+4 competence to Fortitude and Will saves for 1 round",
                     Guids.MartialPowerSurvivorManeuver, Guids.SurvivorPath, Guids.SurvivorManeuverBuff, icon);
        BuildVariant("Survivor",      "Survivor's Resolve",    "Temporary HP equal to your manifester level for 1 minute",
                     Guids.MartialPowerSurvivorExpanded, Guids.SurvivorExpandedFeature, Guids.SurvivorExpandedBuff, icon);
