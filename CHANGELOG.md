...
- Advanced Dervish Path feat: while in Dervish Trance and dual-wielding, the trance competence bonus also applies to damage rolls (same +1/+2/+3/+4/+5 scaling and same dual-wield conditions as the attack bonus). Prerequisites: Dervish path, Double Slice, Two-Weapon Fighting, Dex 15, BAB +6, psychic warrior level 10. Movement benefits omitted (not applicable in WotR).
- Advanced Brawler Path feat: while in Brawler Trance, gain a competence bonus to grapple checks equal to +1 per 3 psychic warrior levels (max +6 at level 18). Prerequisites: Brawler path, Improved Unarmed Strike, BAB +6, psychic warrior level 10. Note: Improved Grapple is not a feat in WotR so that prerequisite is omitted; the lethal damage option is already the default behavior of the Brawler Maneuver.
- Advanced Assassin Path feat: while in Assassin's Trance, attacks against flat-footed or flanked targets deal bonus precision damage as a rogue of half your psychic warrior level (1d6 at 2nd, scaling to 5d6 at 18th). Additionally, when your Assassin's Maneuver buff is active, a successful hit forces the target to make a Fortitude save (DC 10 + BAB) or be staggered for a number of rounds equal to your Wisdom modifier. Prerequisites: Assassin's path, Deep Impact, Psionic Weapon, BAB +6, psychic warrior level 10.
